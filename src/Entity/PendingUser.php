...
class PendingUser implements JsonSerializable
{
    ...
    /**
     * @ORM\Embedded(
     *     class="TDW\ACiencia\Entity\IsActive"
     * )
     */
    ...
    public function __construct(
        ...
        string $isActive = IsActive::INACTIVE
    ) {
        $this->id       = 0;
    ...
    {
        return $this->isActive->hasIsActive($isActive);
    }
    ...
    public function getStatus(): array
    {
        $statuses = array_filter(
            IsActive::STATUS,
            fn($myStatus) => $this->hasIsActive($myStatus)
        );
    ...
    public function jsonSerialize(): array
    {
        return [
            'user' => [
                ...
                'isActive' => $this->isActive->__toString(),
                'email' => $this->getEmail(),
